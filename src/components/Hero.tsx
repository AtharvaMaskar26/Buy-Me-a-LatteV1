      ...
      <div className="information-container relative bottom-[65px]">
        ...
        <div className="flex justify-center mt-4">
          <WagmiConfig config={wagmiConfig}>
            ...
            >
              {({ openModal }) => (
                <button className="bg-transperant border-[0.5px] hover:bg-black hover:text-backgroundWhite border-black px-4 py-2 rounded-2xl text-xl font-semibold" onClick={() => openModal()}>Subscribe</button>
              )}
            </SuperfluidWidget>
          </WagmiConfig>
